    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <section className="bg-white rounded-xl border border-gray-200 p-5 sm:p-6 mb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5">
          ...
          {!isActive && (
            <a
              href="mailto:support@lessondeck.app?subject=Activate LessonDeck Subscription"
      ...
      <section id="burst" className="bg-white rounded-xl border border-gray-200 p-5 sm:p-6 mb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <a
            href="mailto:support@lessondeck.app?subject=Purchase Burst Pack"
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 text-sm text-gray-600">
        ...
        <p>
          Lesson plans generated by LessonDeck are licensed for your personal classroom use only. 
